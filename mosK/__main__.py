...
def main():
    from mosK.lib.target import Console
    console = Console()
    console.log("importing libraries...")
    from mosK.lib.target import Target, TARGETS
    from mosK.lib.utils import DPAPI, Chrome
    from mosK.lib.executors.execwmi import ExecWMI
    import IPython
